...
####    -g/--gene   <required>    Gene Symbol to search for in the INFO field, can be a list of genes separated by commas
####
################################################################################################################
################################################################################################################
################################################################################################################
...
## Gene/Text
SearchGene=str(options.geneName).split(',')
