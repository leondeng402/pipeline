...
#Start output table
headerlist=['Chromosome','Position','ID','REF','ALT','Gene','VariantFunction','VariantClass','AAchange','1KG.score','ESP.score','SIFTscore','SIFTprediction','PP2score','PP2prediction','MTscore','MTprediction','GERPscore','PHYLOPscore','CADDscore','QD','QUAL','INFO','Ref','Het','Alt', 'NoCall', 'SampleNum']
    ...
    if '#' not in line:
        ...
        if AltNum > 1:
            for refnum in range(0, AltNum):
                ...
                OutputList=SttList+[GeneName,VariantFunction,VariantClass,AAchange,KGscore,ESPscore,SIFTscore,SIFTprediction,PP2score,PP2prediction,MTscore,MTprediction,GERPscore,PHYLOPscore,CADDscore,QDnumber,QUAL]+linelist[7:8]+[RefCnt,HetCnt,AltCnt,NclCnt,SampleNum]
